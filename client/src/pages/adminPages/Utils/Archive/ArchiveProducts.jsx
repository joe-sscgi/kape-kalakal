...
export const loader = async ({ request }) => {
  try {
    ...
    const { data } = await customFetch.get(
      `/admin/utilities/archive-products?${queryParams.toString()}`
    );
    return data;
  } catch (error) {
    console.error(error);
  ...
  try {
    if (data.action == "restore") {
      await customFetch.patch(
        `/admin/utilities/archive-products/${data.ArchiveID}`,
        data
      );
...
const ArchiveProducts = () => {
  ...
  const list = Object.values(PROD_CAT);
        ...
        <div className="container">
          <div className="filters-container">
            ...
            >
              ...
              <option value="prodCat">Sort by Category</option>
            </select>
